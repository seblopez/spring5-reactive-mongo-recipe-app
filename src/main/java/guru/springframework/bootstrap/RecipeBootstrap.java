...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.addIngredient(Ingredient.builder().description("Kosher salt").amount(BigDecimal.valueOf(.5)).uom(teaSpoonUom).build());
        ...
        tacosRecipe.addIngredient(Ingredient.builder().description("Dried Oregano").amount(BigDecimal.valueOf(1)).uom(teaSpoonUom).build());
        tacosRecipe.addIngredient(Ingredient.builder().description("Dried Cumin").amount(BigDecimal.valueOf(1)).uom(teaSpoonUom).build());
        tacosRecipe.addIngredient(Ingredient.builder().description("Sugar").amount(BigDecimal.valueOf(1)).uom(teaSpoonUom).build());
        tacosRecipe.addIngredient(Ingredient.builder().description("Salt").amount(BigDecimal.valueOf(.5)).uom(teaSpoonUom).build());
